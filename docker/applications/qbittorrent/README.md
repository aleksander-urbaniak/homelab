...
> ✨ **What is qBittorrent?**
>
> qBittorrent is a lightweight BitTorrent client with a web UI.

---

This folder contains a Docker Compose setup for **qBittorrent**.

## 🎯 Quick facts

- Compose file(s): `compose.yml`
- Services: `qbittorrent`
- Images: `linuxserver/qbittorrent:20.04.1`
- Published ports: `8080`
