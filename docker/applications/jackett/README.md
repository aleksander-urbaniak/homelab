...
> ✨ **What is Jackett?**
>
> Jackett provides a unified API for many torrent/Usenet indexers (often used with Sonarr/Radarr).

---

This folder contains a Docker Compose setup for **Jackett**.

## 🎯 Quick facts

- Compose file(s): `compose.yml`
- Services: `jackett`
- Images: `linuxserver/jackett:0.24.671`
- Published ports: `9117`
