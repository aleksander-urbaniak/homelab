...
> ✨ **What is Radarr?**
>
> Radarr is a movie collection manager that can automatically fetch and organize media.

---

This folder contains a Docker Compose setup for **Radarr**.

## 🎯 Quick facts

- Compose file(s): `compose.yml`
- Services: `radarr`
- Images: `linuxserver/radarr:6.0.4`
