...
```bash
kubectl apply -f kubernetes/applications/nexterm/nexterm-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/nexterm/nexterm-namespace.yml
kubectl apply -f kubernetes/applications/nexterm/nexterm-secrets.yml
kubectl apply -f kubernetes/applications/nexterm/nexterm-data-pvc-pvc.yml
kubectl apply -f kubernetes/applications/nexterm/nexterm-service.yml
kubectl apply -f kubernetes/applications/nexterm/nexterm-deployment.yml
kubectl apply -f kubernetes/applications/nexterm/nexterm-ingress.yml
```
