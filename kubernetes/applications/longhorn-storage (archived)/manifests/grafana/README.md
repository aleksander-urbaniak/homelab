...
```bash
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-namespace.yml
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-data-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-app-service.yml
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-deployment.yml
kubectl apply -f kubernetes/applications/manifests/grafana/grafana-ingress.yml
```
