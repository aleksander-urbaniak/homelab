...
```bash
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-namespace.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-db-init-configmap.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-app-service.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-db-service.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-db-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/semaphore/semaphore-ingress.yml
```
