...
```bash
kubectl apply -f kubernetes/applications/manifests/node-exporter/node-exporter-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/node-exporter/node-exporter-namespace.yml
kubectl apply -f kubernetes/applications/manifests/node-exporter/node-exporter-service.yml
kubectl apply -f kubernetes/applications/manifests/node-exporter/node-exporter-daemonset.yml
kubectl apply -f kubernetes/applications/manifests/node-exporter/node-exporter-ingress.yml
```
