...
```bash
kubectl apply -f kubernetes/applications/manifests/affine/affine-manifest.yml
```
...
```bash
kubectl apply -f kubernetes/applications/manifests/affine/affine-namespace.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-secrets.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-config-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-storage-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-postgres-service.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-redis-service.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-service.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-deployment.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-redis-deployment.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-postgres-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-migration-job.yml
kubectl apply -f kubernetes/applications/manifests/affine/affine-ingress.yml
```
