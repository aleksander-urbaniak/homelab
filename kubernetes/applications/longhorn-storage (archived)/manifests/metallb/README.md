...
```bash
kubectl apply -f kubernetes/applications/manifests/metallb/metallb-addr-pool.yml
kubectl apply -f kubernetes/applications/manifests/metallb/metallb-l2-advertisment.yml
```
