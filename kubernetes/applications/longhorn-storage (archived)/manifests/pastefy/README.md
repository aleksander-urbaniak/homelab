...
```bash
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-namespace.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-secrets.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-app-service.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-db-headless-service.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-db-service.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-app-deployment.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-mariadb-db-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/pastefy/pastefy-ingress.yml
```
