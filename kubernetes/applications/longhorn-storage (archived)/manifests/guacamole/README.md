...
```bash
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-namespace.yml
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-app-service.yml
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-headless-service.yml
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/guacamole/guacamole-ingress.yml
```
