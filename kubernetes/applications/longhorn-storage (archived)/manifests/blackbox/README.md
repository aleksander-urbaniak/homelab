...
```bash
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-namespace.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-config-configmap.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/config-map-blackbox-config-configmap.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/config-map-manifest.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-exporter-service.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-exporter-deployment.yml
kubectl apply -f kubernetes/applications/manifests/blackbox/blackbox-ingress.yml
```
