...
```bash
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-namespace.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-serviceaccount.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-clusterrole.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-clusterrolebinding.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-service.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-deployment.yml
kubectl apply -f kubernetes/applications/manifests/kube-state-metrics/kube-state-metrics-ingress.yml
```
