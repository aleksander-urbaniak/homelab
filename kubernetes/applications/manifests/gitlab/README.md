...
```bash
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-namespace.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-config-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-data-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-logs-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-pgdata-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-service.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-deployment.yml
kubectl apply -f kubernetes/applications/manifests/gitlab/gitlab-ingress.yml
```
