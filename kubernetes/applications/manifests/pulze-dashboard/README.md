...
```bash
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-namespace.yml
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-data-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-service.yml
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-deployment.yml
kubectl apply -f kubernetes/applications/manifests/pulze-dashboard/pulze-dashboard-ingress.yml
```
