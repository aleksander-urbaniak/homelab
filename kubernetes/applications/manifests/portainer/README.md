...
```bash
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-namespace.yml
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-data-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-service.yml
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-deployment.yml
kubectl apply -f kubernetes/applications/manifests/portainer/portainer-ingress.yml
```
