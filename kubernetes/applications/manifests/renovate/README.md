...
```bash
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-namespace.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-secrets.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-db-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-logs-pvc-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-service.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-deployment.yml
kubectl apply -f kubernetes/applications/manifests/renovate/renovate-ingress.yml
```
