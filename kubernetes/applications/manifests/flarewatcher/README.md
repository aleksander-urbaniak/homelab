...
```bash
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-namespace.yml
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-secrets.yml
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-data-pvc-pvc.yml
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-service.yml
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-deployment.yml
kubectl apply -f kubernetes/applications/manifests/flarewatcher/flarewatcher-ingress.yml
```
