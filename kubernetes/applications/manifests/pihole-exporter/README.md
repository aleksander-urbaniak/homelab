...
```bash
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-namespace.yml
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-secrets.yml
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-certs-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-service.yml
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-deployment.yml
kubectl apply -f kubernetes/applications/manifests/pihole-exporter/pihole-exporter-ingress.yml
```
