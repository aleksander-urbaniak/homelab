...
```bash
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-manifest.yml
```

### Option B: apply the split manifests

```bash
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-namespace.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-secrets.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-config-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-web-persistentvolumeclaim.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-app-service.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-db-headless-service.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-db-service.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-deployment.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-db-statefulset.yml
kubectl apply -f kubernetes/applications/manifests/speedtest-tracker/speedtest-tracker-ingress.yml
```
