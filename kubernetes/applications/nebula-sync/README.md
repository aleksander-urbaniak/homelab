...
```bash
kubectl apply -f kubernetes/applications/nebula-sync/nebula-sync-manifest.yml
```
...
kubectl apply -f kubernetes/applications/nebula-sync/nebula-sync-ingress.yml
```
