...
```bash
kubectl apply -f kubernetes/applications/cloudflared/cloudflared-namespace.yml
kubectl apply -f kubernetes/applications/cloudflared/cloudflared-secrets.yml
kubectl apply -f kubernetes/applications/cloudflared/cloudflared-deployment.yml
```
