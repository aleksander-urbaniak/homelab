...
- Namespace: `grafana`
- Images: `busybox:1.37`, `grafana/grafana:12.3.1`
...
- `grafana-manifest-example.yml`: Example combined manifest (with placeholders)
...
1. Edit `grafana-manifest-example.yml` and replace placeholders.
2. Apply:

```bash
kubectl apply -f kubernetes/applications/grafana/grafana-manifest-example.yml
```
